...
2. Make sure that the NAMESPACE file in your packages includes a line with `import(sumR)`. If you are using the roxygen2 documentation package, this can be achieved by adding `#' @import sumR` in one of your R files, such as yourpackage-package.R, before running roxygen2::roxygenize().
...
#include <Rmath.h> // Required for the log1pl function
#include <sumRAPI.h>
